...
Есть 3 варианта, как увидеть результат моей работы (что скрывается за кодом в этом репозитории?):
...
- Если у вас есть доступ к удалённому серверу и вы не против установить не него Docker и Docker-compose, то [здесь](#инструкции_по_развороту_проекта_на_сервере) описано, как поднять проект на сервере.
...
- написать бэкенд (API) к онлайн-сервису "Продуктовый помощник" по техническому заданию (спецификация API). 
...
1. [сайт Foodgram, «Продуктовый помощник». Техническое описание проекта](#техническое_описание_проекта)<br> 
        1.1 [Сервисы и страницы проекта](#страницы_проекта)<br> 
        1.2.[Фильтрация по тегам](#фильтр_теги)<br>
        1.3 [Аутентификация, права доступа](#пользователи)<br> 
        1.4 [Технические требования и ифраструктура](#технические_требования)
2. [Инструкции по развороту проекта локально](#инструкции_по_развороту_проекта_локально)       
3. [Инструкции по развороту проекта на сервере](#инструкции_по_развороту_проекта_на_сервере)
4. [Примеры запросов и ответов к API](#примеры_запросов_и_ответов_к_API)    
...
[:arrow_up:Оглавление](#Оглавление)
___
<a name="технические_требования"></a> 
...
6) Теперь проект доступен по адресам: <br>
[главная страница](http://localhost/recipes/) <br>

[Докуметация к API](http://localhost/api/docs/) <br>
...
<a name="инструкции_по_развороту_проекта_на_сервере"></a>
